...
#define CONFIG_BOOTCOMMAND				"eeprom read 0x48000000 0x100000 0x400000;eeprom read 0x49000000 0x500000 0x700000;bootm 0x48000000"
...
#define	FASTBOOT_PARTS_DEFAULT		\
			...
			"flash=eeprom,0:boot:raw:0x00100000,0x00400000;"	\
			"flash=eeprom,0:system:raw:0x00500000,0x00B00000;"
#endif
...
#if 0//defined(CONFIG_LOGO_DEVICE_MMC) && defined(CONFIG_LOGO_DEVICE_NAND)
