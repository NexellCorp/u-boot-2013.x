...
//#define CONFIG_BOOTCOMMAND				"ext4load mmc 0:1 0x40008000 Image;ext4load mmc 0:1 0x42000000 root.img.gz;goimage 0x40008000"
#define CONFIG_BOOTCOMMAND				"nand read 0x44000000 0xb00000 0x400000; nand read 0x43000000 0x300000 0x400000; bootm 0x43000000"
...
//	#define	CONFIG_MTD_NAND_BMT_FIRST_LAST													/* Samsumg 8192 page nand write bad mark on 1st and last block */
	...
	#define CONFIG_CMD_NAND_UPDATE
		...
		#define	CONFIG_ENV_OFFSET			1024*1024										/* 0x00100000 */
...
#define CONFIG_DISPLAY_OUT
	...
	// #define CONFIG_CMD_LOGO_LOAD            "ext4load mmc 1:1 0x43000000 logo.bmp;bootlogo 0x43000000"
	//#define CONFIG_CMD_LOGO_LOAD			"nand read 0x62000000 0x2000000 0x400000; bootlogo 0x62000000"
#endif
