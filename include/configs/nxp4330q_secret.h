...
//#define CONFIG_SECRET_3P1RD_BOARD // 2014.06 HW 3.1
...
#endif
    #define CONFIG_MMC1_CLK_DELAY       DW_MMC_DRIVE_DELAY(0x0) | DW_MMC_SAMPLE_DELAY(0x0) | DW_MMC_DRIVE_PHASE(2)| DW_MMC_SAMPLE_PHASE(1)
    #define CONFIG_MMC2_CLK_DELAY       DW_MMC_DRIVE_DELAY(0x0) | DW_MMC_SAMPLE_DELAY(0x1c) | DW_MMC_DRIVE_PHASE(2)| DW_MMC_SAMPLE_PHASE(1)
