...
#define PART_SIZE_FWBL1		0//(8 * 1024)
#else
#define PART_SIZE_FWBL1		0
#endif
#define PART_SIZE_BL1		0//(16 * 1024)
#define PART_SIZE_UBOOT		(512 * 1024)
#define PART_SIZE_KERNEL	(4 * 1024 * 1024)
#define PART_SIZE_ROOTFS	(26 * 1024 * 1024)

#define MOVI_FWBL1_BLKCNT	0//(PART_SIZE_FWBL1 / MOVI_BLKSIZE)
#define MOVI_BL1_BLKCNT		0//(PART_SIZE_BL1 / MOVI_BLKSIZE)
