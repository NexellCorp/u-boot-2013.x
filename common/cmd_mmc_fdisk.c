...
//-----------------------------------------------------
        else
        {
                ...
                if (count == BLOCK_END)
                {
                        ...
                        partInfo->block_end     = sdInfo.total_block_count - 1;
                        partInfo->block_count   = partInfo->block_end - partInfo->block_start + 1;
                        printf("%s: total blk count %d, blk_end %d, blk_count %d\n", __func__, sdInfo.total_block_count,
                                partInfo->block_end, partInfo->block_count);
...
///////////////////////////////////////////////////////////
// \B9ݵ\E5\BD\C3 Unit\B4\DC\C0\A7\B7\CE \B8\D5\C0\FA \B0\E8\BB\EA\C7Ѵ\D9.
#ifndef CONFIG_MACH_NXP4330Q
...
#else
	block_start = calc_unit(CFG_BOOT_PART_START, sdInfo);
	if (flag)
		block_offset = calc_unit((unsigned long long)simple_strtoul(argv[3], NULL, 0)*1024*1024, sdInfo);
	else
		block_offset = calc_unit(CFG_BOOT_PART_SIZE, sdInfo);
...
///////////////////////////////////////////////////////////
	...
	if (flag)
		...
		block_offset = calc_unit(CFG_SYSTEM_PART_SIZE, sdInfo);
...
///////////////////////////////////////////////////////////
	...
	if (flag)
		...
		block_offset = calc_unit(CFG_CACHE_PART_SIZE, sdInfo);
